            ...
            <ScrollView contentContainerStyle={styles.container} showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false} >
                ...
                <View style={{ flexDirection: "row", marginTop: 0}}>
                    <View style={{ flex: 1, paddingRight: 7 }}>
                        <CardReport05 style={{ marginTop: 7 }} title="Finish Countdown" price={refEndBlock - currentBlockNumber} icon = "clock" onPress={() => navigation.navigate("FCryptol02")}/>
                        <CardReport05 style={{ marginTop: 10 }} title="Scoring Countdown" price={refScoreBlock - currentBlockNumber} icon = "clock" onPress={() => navigation.navigate("FCryptol02")} />
                        {/* 5 */}
                    ...
                    <View style={{ flex: 1, paddingLeft: 7 }}>
                        ...
                        <CardReport04 contentStyle={{ paddingBottom: 15, marginBottom: 7, marginTop: 7 }}
                            ...
                            percent1= {(refAye / (refAye + refNay))*1000} nay="NAY - " percent2= {(refNay / (refAye + refNay))*1000} percent= {(refAye / (refAye + refNay))*1000}
